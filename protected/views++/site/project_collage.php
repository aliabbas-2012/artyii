                                ...
                                <?php if (isset($result_bg['cropped_img']) && !empty($result_bg['cropped_img'])) { ?>
                                        ...
                                        <div style="width:20%;float:left;">
                                            ...
                                            <div style="border: 5px solid #fff;padding:10px;">
                                                <img class="edit_img" background="yes" img_name="<?php echo $result_bg['main_img']; ?>" imgkey="<?php echo $result_bg['img_key']; ?>" style="cursor:pointer; width: 192px;height: 200px;" src="<?php echo BASE_URL; ?>/collage/<?php echo $result_bg['main_img']; ?>" alt="alt" />
                                            </div>
                                        </div>
