...
(function( $ ){
  ...
  $.fn.birthdaypicker = function( options ) {
    ...
    return this.each(function() {
      ...
      var $fieldset = $("<div class='birthday-picker'></div>"),
          $year = $("<select style='width:85px;padding: 4px;' id='syear' class='birth-year' name='birth[year]'></select>"),
          $month = $("<select style='width:85px;padding: 4px;' id='smonth' class='birth-month' name='birth[month]'></select>"),
          $day = $("<select  style='width:85px;padding: 4px;' id='sday' class='birth-day' name='birth[day]'></select>");
