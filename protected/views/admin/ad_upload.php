...
<script>
    ...
    function loadprojectimages() {
        $.post('<?php echo Yii::app()->request->baseUrl; ?>' + '/admin/loadimages', {
            newimage: newimage,
            ukey: ukey
        }, function(data) {
    ...
    function cropimage() {
        ...
        $.post('<?php echo Yii::app()->request->baseUrl; ?>' + '/admin/cropimg', {
            imgkey: cuimagekey,
            ukey: ukey,
            x: g_x,
            y: g_y,
...
<div id="gameSection" style="padding-top:0px;">
    <div style="min-height: 300px; background:white;">
        <div id="pageTitle" style="padding:20px;text-align: center;">
            <h2 class="thick-title page-title-bar">Background Images</h2>
        </div>
        <div style="width:100%;">
