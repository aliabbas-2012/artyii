...
class SiteController extends AppController {
    ...
    public function actionCreate() {
        ...
        if (isset($_POST['Project'])) {
            ...
            if($model->save())
            $this->redirect(array(Yii::app()->params['AppUrls']['si_upload_project_img'] . "/?ukey=" . $model->ukey));
        }
        ...
        if (!empty($_POST['ukey'])) {
            ...
            if (isset($result['ukey'])) {
                ...
                if (!empty($_file_name)) {
                    ...
                    if(isset($back_img['project_key']) && isset($_POST['background'])){
    ...
    public function actionCollage() {
        ...
        if (!empty($_GET['ukey'])) {
            ...
            if (isset($result['ukey'])) {
                ...
                $command = Yii::app()->db->createCommand("SELECT * From tbl_images where project_key = '$_ukey' and bg_img = 1");
