...
class WSocialButton extends CWidget {
    ...
    public function init() {
        ...
        Yii::app()->clientScript->registerScriptFile('http://connect.facebook.net/en_US/all.js#appId=134088429225&xfbml=1', CClientScript::POS_END);
    }
        ...
        ?>
            ...
            <table style="width: auto;">
                <tr>                
                    ...
                    <td><div id="fb-root"></div><fb:share-button href="" type="button_count"></fb:share-button></td>
                </tr>
            </table>
            <?php endif;?>
