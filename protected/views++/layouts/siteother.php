            ...
            <div id="head">
                <div id="headerSection">
                    <div id="menu-container">
                        ...
                        <div id="logo">
                            <a href="<?php echo $this->createUrl(Yii::app()->params['AppUrls']['si_index']); ?>"><img alt="undefined" title="" src="<?php echo BASE_URL; ?>/images/logo4.png"></a>
                        </div>
                        <div id="headLinks">
                    ...
                    <div id="head-banner-right-top">
                        ...
                        <div class="shortFormContainer">
                            ...
                            <div class="textblock" style="margin-top: -20px;">
                                <form name="contactus" id="contactus" method="post" action="<?php echo $this->createUrl(Yii::app()->params['AppUrls']['si_index']); ?>/">
